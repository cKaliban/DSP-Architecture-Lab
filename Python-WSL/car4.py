...
cv2.imwrite("car2_frame.jpg", img)
cv2.imshow('Cropped',Cropped)
# thresh = cv2.equalizeHist(Cropped)
...
# cv2.imwrite("car2_mod.jpg", thresh)
img_new = cv2.imread("car4_mod2.jpg")

# img_new = cv2.bilateralFilter(img_new, 11, 17, 17)
# cv2.imshow("t", img_new)
cv2.waitKey(0)
result = pytesseract.image_to_string(img_new, lang = 'eng', config="--oem 1 --psm 7")
print(result)
